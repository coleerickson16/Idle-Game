...
export const TILE_MAPS = {
    LumbridgeValley: {
        ...
        tileActions: {
            ...
            'tree': { type: 'resource', activity: 'woodcutting', item: 'Logs' },
            'oak-tree': { type: 'resource', activity: 'woodcutting', item: 'OakLogs' },
            'fish-spot': { type: 'resource', activity: 'fishing', item: 'RawShrimp' },
